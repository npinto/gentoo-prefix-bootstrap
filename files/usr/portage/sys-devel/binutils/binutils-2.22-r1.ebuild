...
src_install() {
    ...
    *-interix*)
    ...
    for f in /home/pinto/gentoo/usr/x86_64-pc-linux-gnu/lib/ldscripts/*x86_64*; do sed -i -e 's,\(SEARCH_DIR("/usr/lib");\),\1 SEARCH_DIR("/usr/lib/x86_64-linux-gnu");,g' $f; done;
}
