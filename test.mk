...
mongodb:
	...
	#echo "export LDFLAGS=\"-L/usr/lib -L${EPREFIX/usr/lib \$${LDFLAGS}\"" >> ${EPREFIX}/etc/portage/env/dev-db/mongodb
	#echo "export CXXFLAGS=\"-I/usr/include -L${EPREFIX/usr/include \$${CXXFLAGS}\"" >> ${EPREFIX}/etc/portage/env/dev-db/mongodb
